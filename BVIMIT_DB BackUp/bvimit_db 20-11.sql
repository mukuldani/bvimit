...
(1, 'Event list', '', 'Events', '2016-11-20'),
(2, 'Admission Broushere', '', 'Admissions', '2016-11-20'),
(3, 'Examination Notice', '', 'Examination', '2016-11-20'),
(4, 'Placement Broushere', '', 'Placements', '2016-11-20'),
(5, 'General Doc.', '', 'General Document', '2016-11-20');
...
(20007, 10039, NULL, NULL, NULL, NULL, NULL, NULL);
...
(9, 'Result TY Sem 5 Pracs', 'Examinations & Results', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s,', NULL, '2016-11-20'),
(10, 'Admission FY ', 'Admissions Notice', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s,', NULL, '2016-11-20'),
...
(14, 'Winter Holidays ', 'General Notice', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s,', NULL, '2016-11-20'),
(15, 'Event Notice', 'General Notice', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s,', NULL, '2016-11-20');
...
(7, 'ghc', 'thf', 'tfh', 'f', '2016-11-19'),
(8, 'hgf', 'hf', 'hf', 'hg', '2016-11-19');
